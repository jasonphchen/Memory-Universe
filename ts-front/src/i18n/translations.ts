...
const cn = {
  ...
  photosSelectedCount: (p: { count: number }) => `已选择 ${p.count} 张`,
  photosCurrentCount: (p: { count: number }) => `当前 ${p.count} 张`,
  photosHint: '可添加多张图片',
...
const en: Translations = {
  ...
  photosSelectedCount: (p) => `Selected ${p.count}`,
  photosCurrentCount: (p) => `Current ${p.count}`,
  photosHint: 'Add as many photos as you like',
